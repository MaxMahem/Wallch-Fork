...
properties::properties(QString& img, QWidget *parent) : QDialog(parent), ui(new Ui::properties) {
    ui->setupUi(this);
...
properties::~properties() { delete ui; }

void properties::on_pushButton_clicked() { close(); }
