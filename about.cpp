...
about::about(QWidget *parent) : QDialog(parent), ui(new Ui::about) {
    ...
    ui->textBrowser->setText(QString("<html><head><meta name=\"qrichtext\" content=\"1\" /><style type=\"text/css\">p, li { white-space: pre-wrap; }</style></head>"
                                     "<body style=\" font-family:'Ubuntu';\">"
                                     "<p style=\"margin: 0px; -qt-block-indent: 0; text-indent: 0px;\">%1%2").arg(tr("In random order")).arg(":</p>"
                                     "<p style=\"margin: 0px; -qt-block-indent: 0; text-indent: 0px;\">"
                                        "<span style=\" font-family:'Sans'; font-size:10pt;\">Leon Vytanos </span>"
                                        "<a href=\"mailto:leon.check.me@gmail.com\">"
                                            "<span style=\" font-family:'Sans'; font-size:10pt; text-decoration: underline; color:#ff5500;\">leon.check.me@gmail.com</span></a>"
                                     "</p>"
                                     "<p style=\" margin: 0px; -qt-block-indent:0; text-indent:0px;\">"
                                        "<span style=\" font-family:'Sans'; font-size:10pt;\">Alex Solanos </span>"
                                        "<a href=\"mailto:alexsol.developer@gmail.com\">"
                                            "<span style=\" font-family:'Sans'; font-size:10pt; text-decoration: underline; color:#ff5500;\">alexsol.developer@gmail.com</span></a>"
                                     "</p></body></html>"));
...
void about::on_closeButton_clicked() { close(); }

void about::on_pushButton_clicked() { ui->stackedWidget->setCurrentIndex(0); }

void about::on_pushButton_2_clicked() { ui->stackedWidget->setCurrentIndex(1); }

void about::on_pushButton_3_clicked() { ui->stackedWidget->setCurrentIndex(2); }
